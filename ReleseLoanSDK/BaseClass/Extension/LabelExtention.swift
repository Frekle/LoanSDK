...
extension UILabel {
    ...
    func setAttributeString(str: String, border: Int) {
        ...
        nameStr.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.grayText, range: range)
        let range2 = NSMakeRange(border, str.count-border)
        nameStr.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.theme, range: range2)
